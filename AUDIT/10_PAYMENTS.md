# 10_Payments.md — Payments Payment Subsystem & PSP Adapters
...
- `PaymentsWalletAdapter`: Internal double-entry settlement for P2P transfers, tipping, and virtual gifts.
