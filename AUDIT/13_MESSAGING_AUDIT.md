...
- **System Welcome Automation:** New profiles receive an initial onboarding message from the verified Tukubi platform bot via migration `00015_realtime_welcome.sql`.
