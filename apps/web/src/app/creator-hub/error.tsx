  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center p-6 text-brand-sandstone">
      <div className="bg-brand-dusk/80 border border-slate-800 rounded-3xl p-8 max-w-md w-full text-center space-y-4 shadow-2xl">
        ...
        <h2 className="text-xl font-bold text-white">Creator Hub Unavailable</h2>
        <p className="text-xs text-brand-sandstone/70 leading-relaxed">
          {error.message || 'We could not load your creator metrics and monetization dashboard.'}
        </p>
        <div className="pt-2 flex items-center justify-center gap-3">
          ...
          <button
            type="button"
            onClick={() => reset()}
            className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-brand-sunriseCoral hover:bg-rose-500 text-slate-950 text-xs font-bold transition-colors"
          >
            <RefreshCw className="w-3.5 h-3.5" /> Refresh Studio
          </button>
        </div>
      </div>
    </div>
