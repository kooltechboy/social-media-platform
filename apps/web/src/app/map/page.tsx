    ...
    <div className="min-h-screen bg-[#090D16] text-brand-sandstone p-4 md:p-6 max-w-7xl mx-auto space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-800 pb-6">
        ...
        <div className="relative w-full md:w-72">
          ...
          <input
            ...
            className="w-full bg-brand-dusk border border-slate-800 rounded-2xl pl-10 pr-4 py-2 text-xs text-brand-sandstone placeholder-brand-sandstone/40 focus:outline-none focus:border-brand-caribbeanSea"
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              return (
                <div
                  ...
                  className={`p-5 rounded-3xl border transition-all cursor-pointer flex flex-col justify-between space-y-3 shadow-lg group ${
                    isSelected
                      ? 'bg-brand-caribbeanSea/10 border-brand-caribbeanSea ring-2 ring-brand-caribbeanSea/30'
        ...
        <div className="lg:col-span-4 space-y-5">
          <div className="bg-brand-dusk/90 border border-slate-800 rounded-3xl p-6 shadow-2xl space-y-5">
            <div className="flex items-center justify-between">
              <span className="text-5xl">{selectedNode.flag}</span>
              <span className="text-[10px] font-black px-3 py-1 rounded-full bg-brand-caribbeanSea/20 text-brand-caribbeanSea border border-brand-caribbeanSea/30">
                ACTIVE PULSE
              </span>
            </div>

            <div>
              <h2 className="text-xl font-black text-brand-sandstone">{selectedNode.name}</h2>
              <span className="text-xs font-bold text-brand-caribbeanSea">{selectedNode.trendingTag}</span>
            ...
            <div className="grid grid-cols-2 gap-3 pt-2">
              <div className="p-3 rounded-2xl bg-brand-twilight border border-slate-800 space-y-0.5">
                ...
                <p className="text-base font-black text-brand-sandstone">{selectedNode.creators}</p>
              </div>
              ...
              <div className="p-3 rounded-2xl bg-brand-twilight border border-slate-800 space-y-0.5">
                ...
                <p className="text-base font-black text-brand-sandstone">{selectedNode.businesses}</p>
              </div>
              ...
              <div className="p-3 rounded-2xl bg-brand-twilight border border-slate-800 space-y-0.5">
                ...
                <p className="text-base font-black text-brand-sandstone">{selectedNode.events}</p>
              </div>
            ...
            <div className="space-y-2 pt-2">
              ...
              <Link
                ...
                className="w-full block bg-brand-dusk hover:bg-slate-700 text-slate-200 font-bold py-2.5 rounded-2xl text-xs text-center border border-slate-700 transition-colors"
              >
