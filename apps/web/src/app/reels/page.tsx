  ...
  return (
    <div className="min-h-screen bg-[#090D16] text-brand-sandstone flex flex-col items-center justify-start p-4 gap-6 max-w-5xl mx-auto">
      ...
      <div className="w-full flex items-center justify-between border-b border-slate-800 pb-4">
        ...
        <Link
          href="/creator-studio"
          className="bg-gradient-to-r from-rose-500 to-brand-goldenHour hover:from-rose-400 hover:to-brand-goldenHour text-slate-950 font-black px-4 py-2 rounded-2xl text-xs transition-all shadow-md shadow-rose-500/20"
        >
          + Upload Short
        </Link>
      </div>
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 items-start justify-center">
        ...
        <div className="lg:col-span-7 flex justify-center">
          <div className="w-full max-w-sm bg-brand-dusk border border-slate-800 rounded-3xl overflow-hidden shadow-2xl relative h-[660px] flex flex-col justify-between p-5">
            ...
            <div className="flex items-center justify-between z-10 relative">
              ...
              <span className="text-xs font-bold text-slate-300 bg-brand-twilight/80 px-2.5 py-1 rounded-full backdrop-blur-md border border-slate-800">
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div className="text-center space-y-3 px-6">
                <div className="w-16 h-16 rounded-full bg-rose-500/20 border border-rose-500/50 flex items-center justify-center mx-auto text-brand-sandstone shadow-xl shadow-rose-500/20">
                  <Play className="w-8 h-8 fill-current translate-x-0.5" />
                </div>
                <div className="flex items-center justify-center gap-1.5 text-xs text-slate-300">
                  <Volume2 className="w-4 h-4 text-brand-caribbeanSea" />
            ...
            <div className="absolute right-4 bottom-24 flex flex-col items-center gap-4 z-10">
              <button className="flex flex-col items-center gap-1 text-slate-200 hover:text-rose-400 transition-colors group">
                <div className="w-11 h-11 rounded-full bg-brand-twilight/80 border border-slate-800 flex items-center justify-center group-hover:scale-110 transition-transform">
                  <Heart className="w-5 h-5 text-rose-500 fill-rose-500/20" />
                </div>
                <span className="text-[11px] font-bold text-slate-300">{featured.likes}</span>
              </button>

              <button className="flex flex-col items-center gap-1 text-slate-200 hover:text-brand-caribbeanSea transition-colors group">
                <div className="w-11 h-11 rounded-full bg-brand-twilight/80 border border-slate-800 flex items-center justify-center group-hover:scale-110 transition-transform">
              ...
              <button className="flex flex-col items-center gap-1 text-slate-200 hover:text-brand-sunriseCoral transition-colors group">
                <div className="w-11 h-11 rounded-full bg-brand-twilight/80 border border-slate-800 flex items-center justify-center group-hover:scale-110 transition-transform">
              ...
              <Link
                href="/spotpay"
                className="flex flex-col items-center gap-1 text-brand-sunriseCoral hover:text-emerald-300 transition-colors group"
              >
                <div className="w-11 h-11 rounded-full bg-brand-sunriseCoral/20 border border-brand-sunriseCoral/50 flex items-center justify-center group-hover:scale-110 transition-transform shadow-lg shadow-brand-sunriseCoral/20">
                  <Wallet className="w-5 h-5 text-brand-sunriseCoral" />
                </div>
                <span className="text-[10px] font-black uppercase text-brand-sunriseCoral">Tip</span>
              </Link>
            </div>
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="bg-brand-dusk/80 border border-slate-800 rounded-3xl p-5 space-y-4 shadow-xl">
            <h3 className="font-extrabold text-sm text-brand-sandstone flex items-center gap-2 uppercase tracking-wide">
              <Sparkles className="w-4 h-4 text-brand-goldenHour" /> More Caribbean Shorts
            </h3>
          ...
          <div className="bg-gradient-to-br from-slate-900 via-slate-900 to-rose-950/30 border border-rose-500/20 rounded-3xl p-5 space-y-3 shadow-lg">
            ...
            <div className="space-y-2 pt-1">
              {[
                ...
                <div key={idx} className="flex items-center justify-between p-2.5 rounded-xl bg-brand-twilight/60 text-xs">
                  <div>
                    <p className="font-bold text-slate-200">{s.track}</p>
                    <p className="text-[11px] text-brand-sandstone/40">{s.artist}</p>
                  </div>
