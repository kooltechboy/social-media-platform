    ...
    <div className="w-full space-y-4">
      <form onSubmit={handleSearch} className="relative w-full">
        ...
        <button
          ...
          className="absolute right-2 top-2 bg-sky-500 hover:bg-sky-400 disabled:opacity-40 text-slate-950 font-bold px-4 py-1.5 rounded-full text-xs transition-colors flex items-center gap-1.5"
        >
      ...
      {result && (
        <div className="bg-gradient-to-r from-sky-950/40 via-slate-900 to-amber-950/20 border border-sky-500/30 rounded-3xl p-5 space-y-3">
