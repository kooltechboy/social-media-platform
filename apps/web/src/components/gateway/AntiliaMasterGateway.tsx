...
export function AntiliaMasterGateway() {
  const [authCardTab, setAuthCardTab] = useState<'signin' | 'signup_intro'>('signin');

  return (
    <div className="min-h-screen w-full bg-[#060A13] text-brand-sandstone relative overflow-x-hidden select-none">
      {/* ── Top Atmospheric Background Glow ── */}
      <div className="absolute top-0 left-1/4 w-[700px] h-[500px] rounded-full bg-brand-caribbeanSea/10 blur-[150px] pointer-events-none" />
      <div className="absolute top-1/3 right-10 w-[600px] h-[600px] rounded-full bg-brand-sunriseCoral/10 blur-[160px] pointer-events-none" />
      <div className="absolute bottom-10 left-10 w-[600px] h-[600px] rounded-full bg-brand-sunsetPurple/15 blur-[150px] pointer-events-none" />

      {/* ── 1. Top Navigation Bar ── */}
      <header className="relative z-30 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex items-center justify-between border-b border-white/5">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-brand-caribbeanSea via-brand-goldenHour to-brand-sunriseCoral p-[1.5px] shadow-xl shadow-brand-caribbeanSea/25">
        ...
        <nav className="hidden md:flex items-center gap-6 text-xs font-semibold text-brand-sandstone/70">
          ...
          <Link href="/spotpay" className="hover:text-white transition-colors">
            SpotPay
          </Link>
        </nav>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/signup"
            className="hidden sm:inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-black bg-gradient-to-r from-brand-caribbeanSea to-brand-sunriseCoral text-[#060A12] hover:opacity-95 transition-all shadow-lg shadow-brand-caribbeanSea/20 active:scale-95"
          >
      ...
      <section className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 lg:pt-12 lg:pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          {/* Left Column: Brand & Value Proposition */}
          <div className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-brand-caribbeanSea/10 border border-brand-caribbeanSea/30 text-brand-caribbeanSea text-xs font-bold uppercase tracking-wider backdrop-blur-xl">
            ...
            <div className="space-y-3">
              ...
              <p className="text-base sm:text-lg text-brand-sandstone/80 font-normal leading-relaxed max-w-xl">
            ...
            <div className="flex flex-wrap items-center gap-3.5 pt-2">
              <Link
                href="/signup"
                className="px-6 py-3.5 rounded-2xl font-black text-sm tracking-wide bg-gradient-to-r from-brand-sunriseCoral via-brand-goldenHour to-brand-caribbeanSea text-[#060A12] shadow-xl shadow-brand-sunriseCoral/20 hover:opacity-95 active:scale-[0.98] transition-all flex items-center gap-2"
              >
              ...
              <Link
                href="/explore"
                className="px-6 py-3.5 rounded-2xl font-bold text-sm text-white bg-white/10 hover:bg-white/15 border border-white/15 backdrop-blur-xl transition-all flex items-center gap-2 active:scale-[0.98]"
              >
            ...
            <div className="pt-6 border-t border-white/10">
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                <div className="p-3.5 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl">
                  ...
                  <p className="text-[11px] text-brand-sandstone/60 font-medium leading-tight">
      ...
      <section className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-white/5">
        <ShowcaseMoments />
      </section>
      ...
      {/* ── 6. Master Footer ── */}
      <footer className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-brand-sandstone/50">
        <div className="flex items-center gap-3">
