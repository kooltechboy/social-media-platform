    ...
    <div className="flex items-center gap-2">
      {!isOwnProfile && isAuthenticated && (
        <Link
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-brand-caribbeanSea/20 hover:bg-brand-caribbeanSea text-brand-caribbeanSea hover:text-slate-950 border border-brand-caribbeanSea/30 text-xs font-bold transition-all"
        >
      ...
      <button
        ...
        className="p-2 text-slate-300 hover:text-brand-sandstone rounded-full hover:bg-brand-dusk border border-slate-800 transition-colors flex items-center gap-1 text-xs"
      >
        {copied ? (
          <>
