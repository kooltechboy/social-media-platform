...
BEGIN
    ...
    VALUES (
        conv_id,
        official_id,
        'Welcome to CARIBBEAN ONE — the digital home of the Caribbean and its global diaspora. Explore communities, events and creators, and say hello in your local diaspora hub. 🌴',
        'text'
    );
