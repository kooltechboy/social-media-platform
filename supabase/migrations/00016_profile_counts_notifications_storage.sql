...
-- No INSERT/UPDATE/DELETE policies for clients ΓÇö only service role and
...
--   ΓÇó following_id gains +1 followers_count
--   ΓÇó follower_id gains +1 following_count
...
-- No DELETE policy ΓÇö preferences are cascade-deleted with the profile only.
