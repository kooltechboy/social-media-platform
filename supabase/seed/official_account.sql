-- Seed: official CARIBBEAN ONE account + launch content
...
BEGIN
    ...
    VALUES (official_id, 'caribbean_one', 'CARIBBEAN ONE',
    ...
    IF NOT EXISTS (SELECT 1 FROM public.posts WHERE author_id = official_id) THEN
        INSERT INTO public.posts (author_id, content, visibility) VALUES
            (official_id,
             'Welcome to CARIBBEAN ONE 🌴 The digital home of the Caribbean and its global diaspora. Connect with your islands, your communities, and your culture — wherever you are.',
             'public'),
            (official_id,
    ...
    VALUES ('Caribbean One Lounge', 'caribbean-one-lounge',
